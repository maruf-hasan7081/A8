...
export function SocialLoginButton({ callbackURL = "/" }: { callbackURL?: string }) {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="btn h-12 w-full border-[#173f35]/15 bg-white text-slate-700 hover:border-[#173f35]/35 hover:bg-[#173f35]/5"
    >
      {loading ? (
