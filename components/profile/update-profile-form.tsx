...
export function UpdateProfileForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="avatar">
          <div className="size-24 overflow-hidden rounded-3xl bg-[#173f35]/10 ring-4 ring-white">
            {image ? (
              ...
              <div className="grid h-full w-full place-items-center text-[#173f35]">
      ...
      {errorMessage ? (
        <div className="alert alert-error rounded-xl py-3 text-sm" role="alert">
      ...
      <div className="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
        <button
          type="button"
          onClick={() => router.back()}
          className="btn h-12 border-[#173f35]/15 bg-white text-[#173f35]"
        >
          Cancel
        </button>
        <button
          ...
          className="btn h-12 border-0 bg-[#173f35] px-6 text-white hover:bg-[#24594b]"
        >
          {loading ? (
