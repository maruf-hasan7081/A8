...
export function Hero() {
  return (
    <section className="paper-grid overflow-hidden border-b border-[#173f35]/10">
      <div className="page-shell grid min-h-[620px] items-center gap-12 py-16 lg:grid-cols-[1.1fr_0.9fr] lg:py-20">
        <div>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link
              href="/books"
              className="btn h-13 border-0 bg-[#173f35] px-6 text-white shadow-lg hover:bg-[#24594b]"
            >
              Browse Now
            ...
            <Link
              href="/register"
              className="btn h-13 border-[#173f35]/20 bg-white px-6 text-[#173f35] hover:border-[#173f35] hover:bg-[#173f35]/5"
            >
              Join the Library
            </Link>
          </div>
          ...
          <div className="mt-10 grid max-w-xl grid-cols-3 gap-3">
            {[
              ...
              <div
                key={label}
                className="rounded-2xl border border-[#173f35]/10 bg-white/70 p-4 backdrop-blur"
              >
