...
export function Footer() {
  return (
    <footer className="mt-20 border-t border-[#173f35]/10 bg-[#112f28] text-[#fffaf0]">
          ...
          <div className="mt-5 flex gap-3">
            {socialLinks.map(({ href, label, icon: Icon }) => (
              <a
                ...
                rel="noreferrer"
                aria-label={label}
                className="grid size-10 place-items-center rounded-xl bg-white/10 transition hover:-translate-y-1 hover:bg-[#d99b3d] hover:text-[#173f35]"
              >
