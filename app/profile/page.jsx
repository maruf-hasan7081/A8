...
import { BadgeCheck, CalendarClock, Edit3, Fingerprint, Mail, ShieldCheck, UserRound, } from "lucide-react";
...
export default async function ProfilePage() {
    ...
    return (<div className="page-shell py-12 sm:py-16">
      <div className="overflow-hidden rounded-[2.25rem] border border-[#173f35]/10 bg-white shadow-xl">
        ...
        <img src={user.image} alt={user.name} className="h-full w-full object-cover"/>) : (<div className="grid h-full w-full place-items-center">
            ...
            <Link href="/profile/update" className="btn h-12 border-0 bg-[#d99b3d] px-5 text-[#173f35] hover:bg-[#e6b660]">
        ...
        <div className="p-6 sm:p-10">
          ...
          <dl className="mt-8 grid gap-4 md:grid-cols-2">
            {details.map(({ label, value, icon: Icon }) => (<div key={label} className="rounded-2xl border border-[#173f35]/10 bg-[#fffdf8] p-5">
